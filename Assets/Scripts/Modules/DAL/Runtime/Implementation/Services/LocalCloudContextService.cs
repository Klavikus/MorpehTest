...
using Modules.DAL.Runtime.Abstract.Services;
using Modules.DAL.Runtime.Implementation.Data.Entities;

namespace Modules.DAL.Runtime.Implementation.Services
{
    public class LocalCloudContextService : ILocalCloudContextService
    {
        ...
        // private bool CheckLevelProgressDifference()
        // {
        //     List<LevelData> cloudProgressData =
